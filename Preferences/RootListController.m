...
- (void)viewDidLoad {
    ...
    self.preferences = [[HBPreferences alloc] initWithIdentifier:@"jam.another.descript"];
    ...
    [[self iconView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AnotherPrefs.bundle/icon.png"]];
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/AnotherPrefs.bundle/Banner.png"]];
